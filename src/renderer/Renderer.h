...
public:
    ...
    //Static draw
    virtual void addStaticSprite(glm::vec3 pos, float width, float height, std::shared_ptr<Sprite> sprite) = 0;
    virtual void addStaticSprite(glm::vec3 pos, float width, float height, SpriteEnum sprite) = 0;
    virtual void clearStaticData() = 0;

    //Dynamic draw
	virtual void drawSprite(glm::vec3 pos, float width, float height, std::shared_ptr<Sprite> sprite) = 0;
